import styles from "./LogoNinja.module.scss";

function LogoNinja() {
  return (
    <>
      <svg className={styles.svg}>
        <symbol id="ic" viewBox="0 -64 640 640">
          <path
      ...
      <svg className={styles.iconNinja}>
        <use className={styles.ic1} xlinkHref="#ic" x="0" y="0" />
      </svg>
    </>
  );
}

export default LogoNinja;
